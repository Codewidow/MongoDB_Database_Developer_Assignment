...
-- db.Students.updateOne({name:'Anurag Pathak'}, {$set:{'name':'Lakshya'})
-- SyntaxError: Unexpected token, expected "," (1:73)

-- [0m[31m[1m>[22m[39m[90m 1 |[39m db[33m.[39m[33mStudents[39m[33m.[39mupdateOne({name[33m:[39m[32m'Anurag Pathak'[39m}[33m,[39m {$set[33m:[39m{[32m'name'[39m[33m:[39m[32m'Lakshya'[39m})
...
--  [90m   |[39m                                                                         [31m[1m^[22m[39m[0m
db.Students.updateOne({name:'Anurag Pathak'},{$set:{'name':'Aditya'}})
{
  acknowledged: true,
  insertedId: null,
  matchedCount: 1,
