...
show collections
Students
db.Students.insertOne({name:'Anurag Pathak', location:'Indore'})
{
  acknowledged: true,
  insertedId: ObjectId('67d9b903726d52f6470e5b75')
}
db.Students.insertOne({name:'Anurag Pathak', location:'Bihar'})
{
  acknowledged: true,
...
db.Students.deleteOne({name:'Anurag Pathak'})
{acknowledged: true,
  insertedId: ObjectId('67d9b903726d52f6470e5b75')
}
